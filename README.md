...
| WARNING  | 30               | Een indicatie dat er iets onverwachts is gebeurd, of dat er in de nabije toekomst een probleem kan optreden (bijv. 'schijfruimte bijna vol'). De software werkt nog steeds zoals verwacht.                                                                                                | Een warning wordt gelogd wanneer er bijvoorbeeld iets mist in de input data van de eenheid die ervoor zorgt dat bepaalde code niet uitgevoerd kan worden. Hetgeen waarvoor gewaarschuwd wordt hoeft geen fout op te leveren, maar is wel belangrijk genoeg om de gebruiker te waarschuwen. Zie het kopje [warnings](#warnings) voor meer informatie over het geven van warnings en hoe hier mee omgegaan wordt.                                                                                                                                                                                                                                                              |
