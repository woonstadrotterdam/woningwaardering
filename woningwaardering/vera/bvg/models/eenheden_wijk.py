...
class EenhedenWijk(BaseModel):
    ...
    naam: Optional[StrictStr] = Field(default=None, description="De naam van de wijk.")
    stadsdeel: Optional[EenhedenStadsdeel] = Field(
        default=None, description="Het stadsdeel van de wijk."
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "code": obj.get("code"),
                "naam": obj.get("naam"),
                "stadsdeel": EenhedenStadsdeel.from_dict(obj["stadsdeel"])
                if obj.get("stadsdeel") is not None
                else None,
            }
        )
        return _obj
