...
class RelatieSleutels(BaseModel):
    ...
    rollen: Optional[conlist(RelatierolSleutels)] = Field(None, description="De rollen behorend bij de relatie. Bijvoorbeeld: Prospect, bewoner.")
    __properties = ["id", "idExtern", "idGegevensbeheerder", "idOrganisatie", "idAdministratie", "code", "soort", "detailSoort", "rollen"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RelatieSleutels:
        """Create an instance of RelatieSleutels from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RelatieSleutels:
        """Create an instance of RelatieSleutels from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RelatieSleutels.parse_obj(obj)

        _obj = RelatieSleutels.parse_obj({
            "id": obj.get("id"),
            ...
            "rollen": [RelatierolSleutels.from_dict(_item) for _item in obj.get("rollen")] if obj.get("rollen") is not None else None
        })
        return _obj
