...
class ConditiemetingSleutels(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConditiemetingSleutels:
        """Create an instance of ConditiemetingSleutels from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConditiemetingSleutels:
        """Create an instance of ConditiemetingSleutels from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConditiemetingSleutels.parse_obj(obj)

        _obj = ConditiemetingSleutels.parse_obj({
            "id": obj.get("id"),
