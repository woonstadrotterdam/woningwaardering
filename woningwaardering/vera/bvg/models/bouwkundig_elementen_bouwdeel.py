...
class BouwkundigElementenBouwdeel(BaseModel):
    ...
    naam: Optional[StrictStr] = Field(None, description="De naam van het bouwdeel.")
    omschrijving: Optional[StrictStr] = Field(None, description="De omschrijving van het bouwdeel.")
    gebouw: Optional[GebouwSleutels] = Field(None, description="Het gebouw behorend bij het bouwdeel.")
    pand: Optional[PandSleutels] = Field(None, description="Het pand behorend bij het bouwdeel.")
    __properties = ["id", "idExtern", "idGegevensbeheerder", "idOrganisatie", "idAdministratie", "code", "naam", "omschrijving", "gebouw", "pand"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BouwkundigElementenBouwdeel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BouwkundigElementenBouwdeel:
        """Create an instance of BouwkundigElementenBouwdeel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BouwkundigElementenBouwdeel.parse_obj(obj)

        _obj = BouwkundigElementenBouwdeel.parse_obj({
            "id": obj.get("id"),
            ...
            "gebouw": GebouwSleutels.from_dict(obj.get("gebouw")) if obj.get("gebouw") is not None else None,
            "pand": PandSleutels.from_dict(obj.get("pand")) if obj.get("pand") is not None else None
        })
        return _obj
