        ...
        _obj = cls.model_validate(
            {
                ...
                "code": obj.get("code"),
                "naam": obj.get("naam"),
                "provincie": Referentiedata.from_dict(obj["provincie"])
                if obj.get("provincie") is not None
                else None,
                "samenwerkingsverband": Referentiedata.from_dict(
                    obj["samenwerkingsverband"]
                )
                if obj.get("samenwerkingsverband") is not None
                else None,
            }
        )
        return _obj
