...
class ClusterSleutels(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClusterSleutels:
        """Create an instance of ClusterSleutels from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClusterSleutels:
        """Create an instance of ClusterSleutels from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClusterSleutels.parse_obj(obj)

        _obj = ClusterSleutels.parse_obj({
            "id": obj.get("id"),
