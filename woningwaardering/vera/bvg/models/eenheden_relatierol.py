...
class EenhedenRelatierol(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EenhedenRelatierol:
        """Create an instance of EenhedenRelatierol from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EenhedenRelatierol:
        """Create an instance of EenhedenRelatierol from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EenhedenRelatierol.parse_obj(obj)

        _obj = EenhedenRelatierol.parse_obj({
            "id": obj.get("id"),
