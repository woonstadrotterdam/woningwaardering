...
class ClustersGeometrieBasis(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClustersGeometrieBasis:
        """Create an instance of ClustersGeometrieBasis from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClustersGeometrieBasis:
        """Create an instance of ClustersGeometrieBasis from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClustersGeometrieBasis.parse_obj(obj)

        _obj = ClustersGeometrieBasis.parse_obj({
