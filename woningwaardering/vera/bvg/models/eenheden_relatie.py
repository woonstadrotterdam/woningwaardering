...
class EenhedenRelatie(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        try:
            instance.actual_instance = EenhedenNatuurlijkPersoon.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into EenhedenRechtspersoon
        try:
            instance.actual_instance = EenhedenRechtspersoon.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
