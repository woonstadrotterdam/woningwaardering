...
class AdresSleutels(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AdresSleutels:
        """Create an instance of AdresSleutels from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AdresSleutels:
        """Create an instance of AdresSleutels from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AdresSleutels.parse_obj(obj)

        _obj = AdresSleutels.parse_obj({
            "id": obj.get("id"),
