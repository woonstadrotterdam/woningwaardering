...
class BouwkundigElementenRelatierol(BaseModel):
    ...
    soort: Optional[Referentiedata] = Field(None, description="Het soort rol van de relatie. Bijvoorbeeld Klant, Prospect, Leverancier, Medewerker, Team etc. Referentiedatasoort RELATIEROLSOORT.")
    naam: Optional[StrictStr] = Field(None, description="De naam van de relatie rol.")
    __properties = ["id", "idExtern", "idGegevensbeheerder", "code", "soort", "naam"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BouwkundigElementenRelatierol:
        """Create an instance of BouwkundigElementenRelatierol from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BouwkundigElementenRelatierol:
        """Create an instance of BouwkundigElementenRelatierol from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BouwkundigElementenRelatierol.parse_obj(obj)

        _obj = BouwkundigElementenRelatierol.parse_obj({
            "id": obj.get("id"),
