...
class EenhedenStadsdeel(BaseModel):
    ...
    naam: Optional[StrictStr] = Field(None, description="De naam van het stadsdeel.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EenhedenStadsdeel:
        """Create an instance of EenhedenStadsdeel from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EenhedenStadsdeel:
        """Create an instance of EenhedenStadsdeel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EenhedenStadsdeel.parse_obj(obj)

        _obj = EenhedenStadsdeel.parse_obj({
            "id": obj.get("id"),
