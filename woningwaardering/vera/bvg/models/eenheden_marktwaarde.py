...
class EenhedenMarktwaarde(BaseModel):
    ...
    beheers_kosten: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None,
        description="Beheerkosten op het moment van waarderen zoals toegepast in de martkwaardeberekening.",
        alias="beheersKosten",
    )
    contract_jaarhuur: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None,
        description="De contractueel afgesproken jaarhuur op het moment van waarderen.",
        alias="contractJaarhuur",
    )
    disconteringsvoet: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Disconteringsvoet op het moment van waarderen."
    )
    doorexploiteren_disconteringsvoet: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None,
        description="Disconteringsvoet doorexploiteren op het moment van waarderen.",
        alias="doorexploiterenDisconteringsvoet",
    )
    leegwaarde: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None,
        description="De geschatte verkoopprijs op basis van de kosten koper, vrij van huur en overige lasten (Handboek MVS).",
    )
    markt_jaarhuur: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None,
        description="Actuele markt jaarhuur op het moment van waarderen.",
        alias="marktJaarhuur",
    )
    onderhouds_kosten: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None,
    ...
    verhuurderheffing: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None,
    ...
    verslag_jaar: Optional[StrictInt] = Field(
        default=None,
