...
class GarantieSleutels(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GarantieSleutels:
        """Create an instance of GarantieSleutels from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GarantieSleutels:
        """Create an instance of GarantieSleutels from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GarantieSleutels.parse_obj(obj)

        _obj = GarantieSleutels.parse_obj({
            "id": obj.get("id"),
