...
class EenhedenVertrek(BaseModel):
    ...
    __properties = ["id", "idExtern", "idGegevensbeheerder", "idOrganisatie", "idAdministratie", "code", "soort", "detailSoort", "naam", "inhoud", "oppervlakte"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EenhedenVertrek:
        """Create an instance of EenhedenVertrek from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EenhedenVertrek:
        """Create an instance of EenhedenVertrek from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EenhedenVertrek.parse_obj(obj)

        _obj = EenhedenVertrek.parse_obj({
            "id": obj.get("id"),
