...
class EenhedenWoonplaats(BaseModel):
    ...
    naam: Optional[StrictStr] = Field(None, description="De naam van de woonplaats.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EenhedenWoonplaats:
        """Create an instance of EenhedenWoonplaats from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EenhedenWoonplaats:
        """Create an instance of EenhedenWoonplaats from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EenhedenWoonplaats.parse_obj(obj)

        _obj = EenhedenWoonplaats.parse_obj({
            "id": obj.get("id"),
