...
class GeometrieSleutels(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GeometrieSleutels:
        """Create an instance of GeometrieSleutels from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GeometrieSleutels:
        """Create an instance of GeometrieSleutels from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GeometrieSleutels.parse_obj(obj)

        _obj = GeometrieSleutels.parse_obj({
            "id": obj.get("id"),
