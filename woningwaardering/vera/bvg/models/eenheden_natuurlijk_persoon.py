...
class EenhedenNatuurlijkPersoon(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EenhedenNatuurlijkPersoon:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EenhedenNatuurlijkPersoon:
        """Create an instance of EenhedenNatuurlijkPersoon from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EenhedenNatuurlijkPersoon.parse_obj(obj)

        _obj = EenhedenNatuurlijkPersoon.parse_obj({
            "id": obj.get("id"),
