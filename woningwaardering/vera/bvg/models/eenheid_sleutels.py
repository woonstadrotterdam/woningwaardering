...
class EenheidSleutels(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EenheidSleutels:
        """Create an instance of EenheidSleutels from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EenheidSleutels:
        """Create an instance of EenheidSleutels from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EenheidSleutels.parse_obj(obj)

        _obj = EenheidSleutels.parse_obj({
            "id": obj.get("id"),
