...
class WoningwaarderingResultatenWoningwaarderingGroep(BaseModel):
    ...
    begindatum: Optional[date] = Field(
        default=None, description="De begindatum van de woningwaardering groep."
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "criteriumGroep": WoningwaarderingResultatenWoningwaarderingCriteriumGroep.from_dict(
                    obj["criteriumGroep"]
                )
                if obj.get("criteriumGroep") is not None
                else None,
                "punten": obj.get("punten"),
                "woningwaarderingen": [
                    WoningwaarderingResultatenWoningwaardering.from_dict(_item)
                    for _item in obj["woningwaarderingen"]
                ]
                if obj.get("woningwaarderingen") is not None
                else None,
            }
        )
        return _obj
