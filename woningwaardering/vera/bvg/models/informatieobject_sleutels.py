...
class InformatieobjectSleutels(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InformatieobjectSleutels:
        """Create an instance of InformatieobjectSleutels from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InformatieobjectSleutels:
        """Create an instance of InformatieobjectSleutels from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InformatieobjectSleutels.parse_obj(obj)

        _obj = InformatieobjectSleutels.parse_obj({
            "id": obj.get("id"),
