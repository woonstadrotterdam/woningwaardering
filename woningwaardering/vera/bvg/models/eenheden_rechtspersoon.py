...
class EenhedenRechtspersoon(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EenhedenRechtspersoon:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EenhedenRechtspersoon:
        """Create an instance of EenhedenRechtspersoon from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EenhedenRechtspersoon.parse_obj(obj)

        _obj = EenhedenRechtspersoon.parse_obj({
            "id": obj.get("id"),
