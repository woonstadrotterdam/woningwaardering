...
class ZaakobjectSleutels(BaseModel):
    ...
    __properties = ["id", "idOrganisatie", "idAdministratie", "code"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ZaakobjectSleutels:
        """Create an instance of ZaakobjectSleutels from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ZaakobjectSleutels:
        """Create an instance of ZaakobjectSleutels from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ZaakobjectSleutels.parse_obj(obj)

        _obj = ZaakobjectSleutels.parse_obj({
            "id": obj.get("id"),
