...
class Foutbericht(BaseModel):
    ...
    code: Optional[StrictStr] = Field(default=None, description="Foutcode")
    omschrijving: Optional[StrictStr] = Field(
        default=None, description="Omschrijving van de fout"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"code": obj.get("code"), "omschrijving": obj.get("omschrijving")}
        )
        return _obj
