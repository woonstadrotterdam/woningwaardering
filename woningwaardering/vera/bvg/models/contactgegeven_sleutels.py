...
class ContactgegevenSleutels(BaseModel):
    ...
    soort: Optional[Referentiedata] = Field(None, description="Het soort communicatie. Bijvoorbeeld: Telefoon, E-mail, .Social media etc. Referentiedatasoort CONTACTGEGEVENSOORT.")
    status: Optional[Referentiedata] = Field(None, description="De status van het contactgegeven. Bijv. Aangemaakt, Gevalideerd, Ongeldig etc. Referentiedatasoort CONTACTGEGEVENSTATUS.")
    __properties = ["id", "idExtern", "idGegevensbeheerder", "idOrganisatie", "idAdministratie", "code", "soort", "status"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContactgegevenSleutels:
        """Create an instance of ContactgegevenSleutels from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContactgegevenSleutels:
        """Create an instance of ContactgegevenSleutels from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContactgegevenSleutels.parse_obj(obj)

        _obj = ContactgegevenSleutels.parse_obj({
            "id": obj.get("id"),
