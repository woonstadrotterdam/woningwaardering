...
class GebouwSleutels(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GebouwSleutels:
        """Create an instance of GebouwSleutels from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GebouwSleutels:
        """Create an instance of GebouwSleutels from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GebouwSleutels.parse_obj(obj)

        _obj = GebouwSleutels.parse_obj({
            "id": obj.get("id"),
