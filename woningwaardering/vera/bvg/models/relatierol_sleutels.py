...
class RelatierolSleutels(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RelatierolSleutels:
        """Create an instance of RelatierolSleutels from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RelatierolSleutels:
        """Create an instance of RelatierolSleutels from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RelatierolSleutels.parse_obj(obj)

        _obj = RelatierolSleutels.parse_obj({
            "id": obj.get("id"),
