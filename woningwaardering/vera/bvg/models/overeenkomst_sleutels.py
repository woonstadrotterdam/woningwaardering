...
class OvereenkomstSleutels(BaseModel):
    ...
    soort: Optional[Referentiedata] = Field(None, description="Het soort overeenkomst. Dit kan bijvoorbeeld arbeidsovereenkomst of koopovereenkomst zijn. Referentiedatasoort OVEREENKOMSTSOORT.")
    __properties = ["id", "idExtern", "idGegevensbeheerder", "idOrganisatie", "idAdministratie", "code", "soort"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OvereenkomstSleutels:
        """Create an instance of OvereenkomstSleutels from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OvereenkomstSleutels:
        """Create an instance of OvereenkomstSleutels from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OvereenkomstSleutels.parse_obj(obj)

        _obj = OvereenkomstSleutels.parse_obj({
            "id": obj.get("id"),
