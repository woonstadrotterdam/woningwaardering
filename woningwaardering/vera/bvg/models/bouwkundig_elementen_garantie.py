...
class BouwkundigElementenGarantie(BaseModel):
    ...
    omschrijving: Optional[StrictStr] = Field(None, description="De omschrijving van de garantie.")
    begindatum: Optional[date] = Field(None, description="De begindatum van de garantie.")
    einddatum: Optional[date] = Field(None, description="De einddatum van de garantie.")
    relatie: Optional[BouwkundigElementenRelatie] = Field(None, description="De leverancier die het product of dienst heeft geleverd.")
    __properties = ["id", "idExtern", "idGegevensbeheerder", "idOrganisatie", "idAdministratie", "code", "omschrijving", "begindatum", "einddatum", "relatie"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BouwkundigElementenGarantie:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BouwkundigElementenGarantie:
        """Create an instance of BouwkundigElementenGarantie from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BouwkundigElementenGarantie.parse_obj(obj)

        _obj = BouwkundigElementenGarantie.parse_obj({
            "id": obj.get("id"),
            ...
            "relatie": BouwkundigElementenRelatie.from_dict(obj.get("relatie")) if obj.get("relatie") is not None else None
        })
        return _obj
