...
class EenhedenRelatieBasis(BaseModel):
    ...
    rollen: Optional[conlist(EenhedenRelatierol)] = Field(None, description="De rollen behorend bij de relatie. Bijvoorbeeld: Prospect, bewoner.")
    __properties = ["id", "idExtern", "idGegevensbeheerder", "idOrganisatie", "idAdministratie", "code", "soort", "detailSoort", "relaties", "rollen"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EenhedenRelatieBasis:
        """Create an instance of EenhedenRelatieBasis from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EenhedenRelatieBasis:
        """Create an instance of EenhedenRelatieBasis from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EenhedenRelatieBasis.parse_obj(obj)

        _obj = EenhedenRelatieBasis.parse_obj({
            "id": obj.get("id"),
            ...
            "rollen": [EenhedenRelatierol.from_dict(_item) for _item in obj.get("rollen")] if obj.get("rollen") is not None else None
        })
        return _obj
