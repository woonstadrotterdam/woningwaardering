...
class EenhedenRuimte(BaseModel):
    ...
    naam: Optional[StrictStr] = Field(
        default=None, description="De omschrijving van de ruimte."
    )
    inhoud: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="De inhoud van de ruimte in m3."
    )
    ligging: Optional[Referentiedata] = Field(
        default=None,
        description="De ligging van de ruimte. Referentiedatasoort RUIMTELIGGING.",
    )
    oppervlakte: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="De oppervlakte van de ruimte"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "ligging": Referentiedata.from_dict(obj["ligging"])
