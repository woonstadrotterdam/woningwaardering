...
class ClustersRelatierol(BaseModel):
    ...
    __properties = ["id", "idExtern", "idGegevensbeheerder", "idOrganisatie", "idAdministratie", "code", "soort", "naam"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClustersRelatierol:
        """Create an instance of ClustersRelatierol from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClustersRelatierol:
        """Create an instance of ClustersRelatierol from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClustersRelatierol.parse_obj(obj)

        _obj = ClustersRelatierol.parse_obj({
            "id": obj.get("id"),
