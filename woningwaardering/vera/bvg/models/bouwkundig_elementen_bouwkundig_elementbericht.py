...
class BouwkundigElementenBouwkundigElementbericht(BaseModel):
    """
    ...
    __properties = ["id", "idExtern", "idGegevensbeheerder", "idOrganisatie", "idAdministratie", "code", "naam", "omschrijving", "serienummer", "soort", "detailSoort", "begindatum", "einddatum", "plaatsingdatum", "bouwdeel", "brandwerendheid", "breedte", "cluster", "constructief", "diameter", "diepte", "dikte", "eenheid", "exterieur", "garanties", "hoogte", "inhoud", "lengte", "locatie", "materiaalDetailsoort", "materiaalSoort", "oppervlakte", "overeenkomsten", "plaatsing", "relaties", "extra-attributen", "informatieobjecten", "sturingslabels"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BouwkundigElementenBouwkundigElementbericht:
        """Create an instance of BouwkundigElementenBouwkundigElementbericht from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BouwkundigElementenBouwkundigElementbericht:
        """Create an instance of BouwkundigElementenBouwkundigElementbericht from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BouwkundigElementenBouwkundigElementbericht.parse_obj(obj)

        _obj = BouwkundigElementenBouwkundigElementbericht.parse_obj({
            "id": obj.get("id"),
