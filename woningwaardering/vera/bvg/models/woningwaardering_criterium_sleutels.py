...
class WoningwaarderingCriteriumSleutels(BaseModel):
    ...
    __properties = ["id", "idExtern", "idGegevensbeheerder", "idOrganisatie", "idAdministratie", "code"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WoningwaarderingCriteriumSleutels:
        """Create an instance of WoningwaarderingCriteriumSleutels from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WoningwaarderingCriteriumSleutels:
        """Create an instance of WoningwaarderingCriteriumSleutels from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WoningwaarderingCriteriumSleutels.parse_obj(obj)

        _obj = WoningwaarderingCriteriumSleutels.parse_obj({
            "id": obj.get("id"),
