...
class EenhedenWozEenheid(BaseModel):
    ...
    vastgestelde_waarde: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="vastgesteldeWaarde", description="De WOZ waarde in euro's die eventueel wordt doorberekend aan de eenheid.")
    waardepeildatum: Optional[date] = Field(None, description="De datum waarop de WOZ waarde is vastgesteld.")
    __properties = ["id", "idExtern", "idGegevensbeheerder", "idOrganisatie", "idAdministratie", "code", "vastgesteldeWaarde", "waardepeildatum"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EenhedenWozEenheid:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EenhedenWozEenheid:
        """Create an instance of EenhedenWozEenheid from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EenhedenWozEenheid.parse_obj(obj)

        _obj = EenhedenWozEenheid.parse_obj({
            "id": obj.get("id"),
            ...
            "code": obj.get("code"),
            "vastgestelde_waarde": obj.get("vastgesteldeWaarde"),
