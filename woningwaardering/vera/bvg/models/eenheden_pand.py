...
class EenhedenPand(BaseModel):
    ...
    lift_aanwezig: Optional[StrictBool] = Field(None, alias="liftAanwezig", description="De aanduiding geeft aan of in het pand in lift aanwezig is.")
    __properties = ["id", "idExtern", "idGegevensbeheerder", "idOrganisatie", "idAdministratie", "code", "liftAanwezig"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EenhedenPand:
        """Create an instance of EenhedenPand from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EenhedenPand:
        """Create an instance of EenhedenPand from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EenhedenPand.parse_obj(obj)

        _obj = EenhedenPand.parse_obj({
            "id": obj.get("id"),
            ...
            "code": obj.get("code"),
            "lift_aanwezig": obj.get("liftAanwezig")
        })
        return _obj
