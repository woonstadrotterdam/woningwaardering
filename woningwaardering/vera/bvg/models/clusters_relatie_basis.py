...
class ClustersRelatieBasis(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClustersRelatieBasis:
        """Create an instance of ClustersRelatieBasis from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClustersRelatieBasis:
        """Create an instance of ClustersRelatieBasis from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClustersRelatieBasis.parse_obj(obj)

        _obj = ClustersRelatieBasis.parse_obj({
            "id": obj.get("id"),
