...
class BouwkundigElementenRechtspersoon(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _contactgegevens_items = []
        if self.contactgegevens:
            for _contactgegevens_item in self.contactgegevens:
                if _contactgegevens_item:
                    _contactgegevens_items.append(_contactgegevens_item.to_dict())
            _dict["contactgegevens"] = _contactgegevens_items
