...
class BouwkundigElementenRechtspersoon(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BouwkundigElementenRechtspersoon:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BouwkundigElementenRechtspersoon:
        """Create an instance of BouwkundigElementenRechtspersoon from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BouwkundigElementenRechtspersoon.parse_obj(obj)

        _obj = BouwkundigElementenRechtspersoon.parse_obj({
            "id": obj.get("id"),
