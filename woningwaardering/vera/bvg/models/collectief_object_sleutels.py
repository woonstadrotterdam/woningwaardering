...
class CollectiefObjectSleutels(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CollectiefObjectSleutels:
        """Create an instance of CollectiefObjectSleutels from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CollectiefObjectSleutels:
        """Create an instance of CollectiefObjectSleutels from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CollectiefObjectSleutels.parse_obj(obj)

        _obj = CollectiefObjectSleutels.parse_obj({
            "id": obj.get("id"),
