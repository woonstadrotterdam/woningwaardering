...
class WoningwaarderingResultatenWoningwaarderingCriteriumGroep(BaseModel):
    ...
    naam: Optional[StrictStr] = Field(default=None, description="De naam van de groep.")
    omschrijving: Optional[StrictStr] = Field(
        default=None, description="De omschrijving van de groep."
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "stelselgroep": Referentiedata.from_dict(obj["stelselgroep"])
                if obj.get("stelselgroep") is not None
                else None,
            }
        )
        return _obj
