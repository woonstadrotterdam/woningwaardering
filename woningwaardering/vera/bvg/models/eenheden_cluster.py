...
class EenhedenCluster(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EenhedenCluster:
        """Create an instance of EenhedenCluster from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EenhedenCluster:
        """Create an instance of EenhedenCluster from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EenhedenCluster.parse_obj(obj)

        _obj = EenhedenCluster.parse_obj({
            "id": obj.get("id"),
