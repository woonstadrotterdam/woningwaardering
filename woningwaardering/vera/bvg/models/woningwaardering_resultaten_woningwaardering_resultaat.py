...
class WoningwaarderingResultatenWoningwaarderingResultaat(BaseModel):
    ...
    __properties = ["id", "idExtern", "idGegevensbeheerder", "idOrganisatie", "idAdministratie", "code", "begindatum", "einddatum", "eenheid", "groepen", "maximaleHuur", "opslagpercentage", "punten", "stelsel"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WoningwaarderingResultatenWoningwaarderingResultaat:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WoningwaarderingResultatenWoningwaarderingResultaat:
        """Create an instance of WoningwaarderingResultatenWoningwaarderingResultaat from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WoningwaarderingResultatenWoningwaarderingResultaat.parse_obj(obj)

        _obj = WoningwaarderingResultatenWoningwaarderingResultaat.parse_obj({
            "id": obj.get("id"),
