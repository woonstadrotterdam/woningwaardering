...
> Indien een eenheid een onzelfstandige woonruimte is, zet `code="ONZ"` en `naam="Onzelfstandige woonruimten"` in het `woningwaarderingstelsel` attribuut van `EenhedenEenheid`.
