...
> Indien bij een vertrek of overig ruimte er sprake is van een gemeenschappelijke ruimte, dient de attribuut `gedeeldMetAantalEenheden` te worden ingevuld. Wanneer `gedeeldMetAantalEenheden` groter is dan 1 wordt het vertrek of de overige ruimte als gemeenschappelijke ruimte gezien. Het oppervlak van de ruimte wordt dan gedeeld door het aantal eenheden.
...
> Idien bij een voorziening er sprake is van een gemeenschappelijke voorziening, dient de attribuut `gedeeldMetAantalEenheden` te worden ingevuld bij de ruimte waarin zich de voorziening bevindt. Wanneer `gedeeldMetAantalEenheden` groter is dan 1 wordt de voorziening als gemeenschappelijke voorziening gezien.
