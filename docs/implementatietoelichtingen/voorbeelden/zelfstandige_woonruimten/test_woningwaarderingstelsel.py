...
def zelfstandige_woonruimte_json():
    ...
    with open(
        "tests/docs/zelfstandige_woonruimten/woningwaarderingstelsel.json", "r"
    ) as f:
        json_data = f.read()
...
def test_zelfstandige_woonruimten_pydantic_equals_json(
    zelfstandige_woonruimte_pydantic, zelfstandige_woonruimte_json
):
