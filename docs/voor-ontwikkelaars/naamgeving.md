...
Bij een nieuwe stelselgroep: kopieer een bestaande implementatie onder `woningwaardering/stelsels/` als uitgangspunt, volg de naamgeving hieronder, en bouw de output met de builders in `woningwaardering/stelsels/builders.py` (zie [criteriumstrategie](criteriumstrategie.md)).
