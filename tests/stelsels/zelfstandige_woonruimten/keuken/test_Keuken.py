...
warning_configs = [
    WarningConfig(
        file=f"{current_file_path}/aanrecht_zonder_lengte/input.json",
        warnings={
            UserWarning: "geen aanrecht",
        },
    ),
    WarningConfig(
        file=f"{current_file_path}/keuken_zonder_aanrecht/input.json",
        warnings={
            UserWarning: "geen aanrecht",
        },
    ),
    WarningConfig(
        file=f"{current_file_path}/2_aanrechten_waarvan_1_geen_lengte/input.json",
        warnings={
            UserWarning: "geen lengte",
        },
    ),
    WarningConfig(
        file=f"{current_file_path}/2_aanrechten_waarvan_1_geen_detailsoort/input.json",
        warnings={
