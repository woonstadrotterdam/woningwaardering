...
Test de waardering van gemeenschappelijke toiletruimten (overige ruimten) met verschillende `gedeeldMetAantalAdressen`-waarden.

Verwacht totaal: **2,75 punten** (1,5 + 1,25).
...
| Ruimte       | Oppervlakte | Adressen | Berekening      | Punten   |
| ------------ | ----------- | -------- | --------------- | -------- |
| Toiletruimte | 10 m²       | 5        | (0,75 × 10) / 5 | 1,5      |
| Toiletruimte | 10 m²       | 6        | (0,75 × 10) / 6 | 1,25     |
| **Totaal**   |             |          |                 | **2,75** |
