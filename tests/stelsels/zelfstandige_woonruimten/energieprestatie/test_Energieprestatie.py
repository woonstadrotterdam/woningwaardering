...
warning_configs = [
    WarningConfig(
        file=f"{current_file_path}/warning_geen_pandsoort/input.json",
        warnings={
            UserWarning: "geen pandsoort",
        },
    ),
    WarningConfig(
        file=f"{current_file_path}/warning_geen_energieprestatie_of_bouwjaar/input.json",
        warnings={
            UserWarning: "geen bruikbare energieprestatie of bouwjaar",
        },
    ),
]
