...
warning_configs = [
    WarningConfig(
        file=f"{current_file_path}/beschermd_stadsgezicht_zonder_bouwjaar/input.json",
        warnings={
            UserWarning: "geen bouwjaar",
        },
    ),
    WarningConfig(
        file=f"{current_file_path}/monumenten_none/input.json",
        warnings={
    ...
    WarningConfig(
        file=f"{current_file_path}/rijksmonument_zonder_datum_afsluiting_huurovereenkomst/input.json",
        warnings={
