...
from woningwaardering.stelsels.onzelfstandige_woonruimten import (
    BijzondereVoorzieningenZorgwoning,
)
...
def test_BijzondereVoorzieningenZorgwoning(
    ...
    bijzondere_voorzieningen_zorgwoning = BijzondereVoorzieningenZorgwoning(
        peildatum=peildatum
    )
    resultaat = bijzondere_voorzieningen_zorgwoning.bereken(
...
def test_BijzondereVoorzieningenZorgwoning_output(
    ...
    resultaat.groepen = [bijzondere_voorzieningen_zorgwoning.bereken(eenheid_input)]
