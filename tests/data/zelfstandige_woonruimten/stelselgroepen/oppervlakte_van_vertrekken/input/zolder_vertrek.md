...
- `Space_1`: zoldervertrek met vaste trap, 10 m² → vertrek.
- `Space_2`: zoldervertrek zonder trapelement, 10 m² → vertrek, want de detailsoort draagt de vaste trap.
- `Space_3`: zoldervertrek met vlizotrap, 10 m² → geen vaste trap, dus geen vertrek; valt terug op overige ruimte.
- `Space_4`: zolder met vaste trap, 10 m² → nooit een vertrek, want een `zolder` voldoet niet aan de afwerkingseisen.
