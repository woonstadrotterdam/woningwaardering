...
- `Space_1`: een zoldervertrek met vaste trap dat met 3 m² te klein is voor een vertrek (2.2.1.2). Telt mee als overige ruimte, zonder correctie.
...
- `Space_3`: een `zolder` van 10 m² met vaste trap. Een `zolder` voldoet volgens VERA niet aan de afwerkingseisen en daarmee niet aan de eis dat het dak beschoten is (2.2.1.3). Telt mee als overige ruimte, zonder correctie.
